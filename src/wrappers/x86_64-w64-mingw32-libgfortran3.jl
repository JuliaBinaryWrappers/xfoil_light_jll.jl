...
const libxfoil_light_splitpath = ["bin", "libxfoil_light.dll"]
...
const libxfoil_light = "libxfoil_light.dll"


# Relative path to `libxfoil_light_cs`
const libxfoil_light_cs_splitpath = ["bin", "libxfoil_light_cs.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libxfoil_light_cs = "libxfoil_light_cs.dll"
